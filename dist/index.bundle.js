...
function todoForm(project, projectBtn) {
    ...
    btn.addEventListener("click", function(e) {
        ...
        const todo = new _todoItem_js__WEBPACK_IMPORTED_MODULE_4__.TodoItem(title, dueDate, priority, description, projectName, false); 
...
function editForm(project, todo, index, projectBtn) {
    ...
    btn.addEventListener("click", function(e) {
        ...
        // title, dueDate, priority, description, project, complete
        const todo = new _todoItem_js__WEBPACK_IMPORTED_MODULE_4__.TodoItem(title, dueDate, priority, description, updatedProjectName, complete); 
...
function loadHeader() {
    ...
    const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), "EEE MMM dd yyyy");
...
function loadProjectContent(project, projectBtn) {
    ...
    if (project.name !== "default") {
        ...
        deleteProjectBtn.addEventListener("click", function(e) {
            (0,_project_js__WEBPACK_IMPORTED_MODULE_3__.deleteProject)(project.name);
            location.reload();
        })
